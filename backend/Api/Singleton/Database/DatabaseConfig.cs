...
namespace Api.Singleton.Database
{
    public static class DatabaseConfig
    {
        ...
        {
            System.Console.WriteLine($"Server={server},{port};Initial Catalog=master;User Id={user};Password={password}");
            services.AddEntityFrameworkSqlServer()
                .AddDbContext<SageBackendContext>(
                    options => options.UseSqlServer($"Server={server},{port};Initial Catalog=master;User Id={user};Password={password}",
